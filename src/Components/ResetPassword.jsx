...
const ResetPassword = () => {
        ...
        const validateToken = async () => {
            try {
                const res = await axios.get('https://password-reset-node-4-backend.onrender.com/api/user/allusers');
        ...
        const onSubmit = async (values) => {
            try {
                const res = await axios.put('https://password-reset-node-4-backend.onrender.com/api/user/resetpassword', { ...values, email });
